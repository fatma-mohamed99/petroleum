  ...
  return (
    <div className="relative w-full overflow-hidden">
      ...
      <div className="relative z-10">
        <OurLegacy />
        <div className="absolute right-20 top-0 h-full w-1 bg-gradient-to-b bg-main  z-0 " />
      </div>
      <div className="relative z-10">
<div className="absolute right-20 top-0 w-[calc(100%-160px)] h-1 bg-gradient-to-b bg-main  z-0" />
        <div className="absolute left-20 top-0 h-full w-1 bg-gradient-to-b bg-main  z-0 " />
