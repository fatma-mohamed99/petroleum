          ...
          <div className="flex flex-col items-center">
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              <button
                ...
                className="bg-black/40 cursor-pointer  hover:bg-black/80 text-white px-5 py-2.5 text-sm transition duration-300 flex gap-2 items-center shadow-md hover:shadow-xl"
              ...
              <button
                ...
                className="border-2 cursor-pointer   text-white px-5 py-2.5 text-sm transition duration-300 flex gap-2 items-center shadow-md hover:shadow-xl hover:bg-black/40"
