...
export const projects:Project[] = [
    {
      ...
      {
        title: "Arab Gas Pipeline, Phase II, Part 1 ",
      ...
      {
        title: " LPG Spherical Tanks in Syria",
      ...
      {
        title: " Areeka Tank Farm",
        image: AreekaTankFarm,
      },
      {
        title: "Ezra Tank Farm  ",
        image: EzraTankFarm
      },
      {
        title: "Fiscal Metering Station for SLGP",
